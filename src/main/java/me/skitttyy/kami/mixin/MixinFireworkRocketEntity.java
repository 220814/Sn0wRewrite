...
public abstract class MixinFireworkRocketEntity implements IMinecraft {
    ...
    @WrapOperation(method = "tick", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/Entity;setVelocity(Lnet/minecraft/util/math/Vec3d;)V"))
    private void wrapSetVelocity(Entity instance, Vec3d velocity, Operation<Void> original) {
    ...
    @WrapOperation(method = "tick", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/Entity;getRotationVector()Lnet/minecraft/util/math/Vec3d;"))
    private Vec3d wrapGetRotationVector(Entity instance, Operation<Vec3d> original) {
